...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" Runat="Server">
	<px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Commerce.Zoey.BCZoeyStoreMaint" PrimaryView="Bindings">
	</px:PXDataSource>
</asp:Content>
<asp:Content ID="cont2" ContentPlaceHolderID="phF" Runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" DataMember="Bindings" TabIndex="6500">
		<Template>
			...
			<px:PXDropDown AllowEdit="False" CommitChanges="True" runat="server" ID="edZoeyDropdownConnectorType" DataField="ConnectorType"></px:PXDropDown>
			<px:PXSelector AutoRefresh="True" AllowEdit="False" CommitChanges="True" runat="server" ID="edZoeySelectorBindingName" DataField="BindingName"></px:PXSelector>
			<px:PXLayoutRule runat="server" ID="CstPXLayoutRule70" StartColumn="True" />
			<px:PXCheckBox CommitChanges="True" AlignLeft="True" runat="server" ID="edZoeyBooleanIsActive" DataField="IsActive"></px:PXCheckBox>
			<px:PXCheckBox AlignLeft="True" runat="server" ID="edZoeyBooleanIsDefault" DataField="IsDefault"></px:PXCheckBox>
		</Template>
	</px:PXFormView>
</asp:Content>
	...
	<px:PXTab ID="tab" runat="server" Width="100%" Height="150px" DataSourceID="ds" DataMember="CurrentStore">
		<Items>
			<px:PXTabItem Text="Connection Settings" Visible="True">
				<Template>
					<px:PXLayoutRule runat="server" StartColumn="True" ID="edZoeyColumn1"></px:PXLayoutRule>
					<px:PXLayoutRule runat="server" ControlSize="XL" LabelsWidth="SM"  StartGroup="True" GroupCaption="Store Settings"></px:PXLayoutRule>
					<px:PXFormView RenderStyle="Simple" DataMember="CurrentBindingZoey" runat="server" ID="frmCurrentBindingZoey1" DataSourceID="ds" TabIndex="18700">
						<Template>
							<px:PXLayoutRule StartColumn="True" ControlSize="XL" LabelsWidth="SM" runat="server" StartRow="True"></px:PXLayoutRule>
							<px:PXTextEdit ID="edStoreAdminUrl" runat="server" AlreadyLocalized="False" DataField="ZoeyApiBaseUrl" CommitChanges="True" IsClientControl="True"></px:PXTextEdit>
							<px:PXTextEdit ID="edApiKey" runat="server" AlreadyLocalized="False" DataField="ZoeyApiKey" CommitChanges="True" IsClientControl="True"></px:PXTextEdit>
							<px:PXTextEdit ID="edApiPassword" runat="server" AlreadyLocalized="False" DataField="ZoeyApiPassword" CommitChanges="True" IsClientControl="True"></px:PXTextEdit>
							<px:PXTextEdit ID="edApiTpken" runat="server" AlreadyLocalized="False" DataField="ZoeyApiToken" CommitChanges="True" IsClientControl="True"></px:PXTextEdit>
							<px:PXTextEdit ID="edApiTokenSecret" runat="server" AlreadyLocalized="False" DataField="ZoeyApiTokenSecret" CommitChanges="True" IsClientControl="True"></px:PXTextEdit>
						</Template>
					</px:PXFormView>
					...
					<px:PXFormView RenderStyle="Simple" DataMember="CurrentBindingZoey" runat="server" ID="PXFormView2" DataSourceID="ds" TabIndex="19100">
						<Template>
							<px:PXLayoutRule StartColumn="True" ControlSize="L" LabelsWidth="SM" runat="server" StartRow="True"></px:PXLayoutRule>
							<px:PXTextEdit runat="server" ID="edZoeyCurrency" DataField="ZoeyDefaultCurrency" AlreadyLocalized="False" IsClientControl="True"></px:PXTextEdit>
							<px:PXTextEdit runat="server" ID="edZoeyStoreTimeZone" DataField="ZoeyStoreTimeZone" AlreadyLocalized="False" IsClientControl="True"></px:PXTextEdit>
							<px:PXTextEdit runat="server" ID="edZoeyStoreName" DataField="StoreName" AlreadyLocalized="False" IsClientControl="True"></px:PXTextEdit>
						</Template>
					</px:PXFormView>
			...
			<px:PXTabItem Text="Customer Settings">
				<Template>
					...
					<px:PXLayoutRule GroupCaption="Customer Group Attributes" runat="server" StartGroup="True"></px:PXLayoutRule>
					<px:PXGrid SyncPosition="True" NoteIndicator="False" FilesIndicator="False" TabIndex="30400" Height="160px" runat="server" ID="CustomerGroups" Caption="Customer Group Attributes" MatrixMode="True" SkinID="Inquire" Width="100%" DataSourceID="ds">
						<Levels>
							<px:PXGridLevel DataMember="CurrentCustomerGroups">
								<Columns>
									<px:PXGridColumn DataField="SortOrder" TextAlign="Right" />
									<px:PXGridColumn CommitChanges="True" DataField="AcumaticaAttribute" Width="140px" />
								 </Columns>
								<RowTemplate>
									<px:PXTextEdit runat="server" CommitChanges="True" ID="edSortOrder" DataField="StoreCategoryID"></px:PXTextEdit>
									<px:PXSelector runat="server" CommitChanges="True" AutoRefresh="True" ID="edGroupAcumaticaAttribute" DataField="AcumaticaAttribute"></px:PXSelector>
								</RowTemplate>
							</px:PXGridLevel>
						</Levels>
		...
		<px:PXTabItem Text="SalesPerson Map">
				<Template>
					<px:PXLayoutRule ControlSize="L" LabelsWidth="M" runat="server" StartColumn="True"></px:PXLayoutRule>
					<px:PXLayoutRule GroupCaption="SalesPerson Mapping" runat="server" StartGroup="True"></px:PXLayoutRule>
					<px:PXGrid SyncPosition="True" TabIndex="30400" Height="160px" runat="server" ID="SalesPersonsMapping" Caption="SalesPerson Mapping" MatrixMode="True" SkinID="Inquire" Width="100%" DataSourceID="ds">
						<Levels>
							<px:PXGridLevel DataMember="CurrentSalesPersons">
								<Columns>
									<px:PXGridColumn CommitChanges="True" TextAlign="Center" Type="CheckBox" DataField="Active" Width="80px"></px:PXGridColumn>
									<px:PXGridColumn CommitChanges="True" DataField="StoreSalesPersonID" Width="140px" />
									<px:PXGridColumn CommitChanges="True" DataField="SalesPersonID" Width="140px" />
								 </Columns>
								
								<RowTemplate>
									<px:PXCheckbox runat="server" CommitChanges="True" ID="edSalesPersonsMappingActive" DataField="Active"></px:PXCheckbox>
									<px:PXTextEdit runat="server" CommitChanges="True" ID="edStoreSalesPersonID" DataField="StoreSalesPersonID"></px:PXTextEdit>
									<px:PXSelector AutoRefresh="True" runat="server" ID="edSalesPersonID" DataField="SalesPersonID"></px:PXSelector>
								</RowTemplate>
							</px:PXGridLevel>
						</Levels>
						<Mode AllowDelete="True" AllowAddNew="True"></Mode>
			...
			<px:PXTabItem Text="Attribute Map">
				<Template>
					<px:PXLayoutRule ControlSize="L" LabelsWidth="M" runat="server" StartColumn="True"></px:PXLayoutRule>
					<px:PXLayoutRule GroupCaption="Attribute Mapping" runat="server" StartGroup="True"></px:PXLayoutRule>
					<px:PXGrid SyncPosition="True" TabIndex="30400" Height="160px" runat="server" ID="AttributesMapping" Caption="Custom Attribute Mapping" MatrixMode="True" SkinID="Inquire" Width="100%" DataSourceID="ds">
						<Levels>
							<px:PXGridLevel DataMember="CurrentAttributes">
								<Columns>
									<px:PXGridColumn CommitChanges="True" TextAlign="Center" Type="CheckBox" DataField="Active" Width="80px"></px:PXGridColumn>
									<px:PXGridColumn DataField="StoreAttributeCode" Width="200px"></px:PXGridColumn>
									<px:PXGridColumn CommitChanges="True" DataField="StoreEntityType" Width="140px"></px:PXGridColumn>
									<px:PXGridColumn CommitChanges="True" DataField="AcumaticaAttribute" Width="140px" />
								 </Columns>
								
								<RowTemplate>
									<px:PXCheckbox runat="server" CommitChanges="True" ID="edAttributesMappingActive" DataField="Active"></px:PXCheckbox>
									<px:PXTextEdit runat="server" CommitChanges="True" ID="edStoreAttributeCode" DataField="StoreAttributeCode"></px:PXTextEdit>
									<px:PXDropDown runat="server" CommitChanges="True" ID="edStoreEntityType" DataField="StoreEntityType"></px:PXDropDown>
									<px:PXSelector AutoRefresh="True" runat="server" ID="edAcumaticaAttribute" DataField="AcumaticaAttribute"></px:PXSelector>
								</RowTemplate>
							</px:PXGridLevel>
						</Levels>
						<Mode AllowDelete="True" AllowAddNew="True"></Mode>
			...
			<px:PXTabItem Text="Category Map">
				<Template>
					<px:PXLayoutRule ControlSize="L" LabelsWidth="M" runat="server" StartColumn="True"></px:PXLayoutRule>
					<px:PXLayoutRule GroupCaption="Category Mapping" runat="server" StartGroup="True"></px:PXLayoutRule>
					<px:PXGrid SyncPosition="True" TabIndex="30400" Height="160px" runat="server" ID="CategoryMapping" Caption="Custom Category Mapping" MatrixMode="True" SkinID="Inquire" Width="100%" DataSourceID="ds">
						<Levels>
							<px:PXGridLevel DataMember="CurrentCategories">
								<Columns>
									<px:PXGridColumn CommitChanges="True" TextAlign="Center" Type="CheckBox" DataField="Active" Width="80px" />
									<px:PXGridColumn CommitChanges="True" DataField="StoreCategoryID" Width="140px" />
									<px:PXGridColumn CommitChanges="True" DataField="AcumaticaCategoryID" Width="140px" />
								 </Columns>
								<RowTemplate>
									<px:PXCheckbox runat="server" CommitChanges="True" ID="edCategoryMappingActive" DataField="Active"></px:PXCheckbox>
									<px:PXTextEdit runat="server" CommitChanges="True" ID="edStoreCategoryID" DataField="StoreCategoryID"></px:PXTextEdit>
									<px:PXSelector runat="server" CommitChanges="True" AutoRefresh="True" ID="edAcumaticaCategoryID" DataField="AcumaticaCategoryID"></px:PXSelector>
								</RowTemplate>
							</px:PXGridLevel>
						</Levels>
						<Mode AllowDelete="True" AllowAddNew="True"></Mode>
